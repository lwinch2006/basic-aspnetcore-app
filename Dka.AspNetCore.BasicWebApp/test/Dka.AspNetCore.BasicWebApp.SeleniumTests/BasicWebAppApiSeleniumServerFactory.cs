...
{
    public class BasicWebAppApiSeleniumServerFactory<TStartup> : WebApplicationFactory<TStartup> where TStartup : class
    {
        private IWebHost _host;

        public string RootUri { get; set; }
        
        public BasicWebAppApiSeleniumServerFactory()
        {
        }
        ...
        private static IConfiguration BuildConfiguration()
        {
            ...
            var appSettingsAppendix = $@"{currentDirectory}\..\..\..\..\..\..\Dka.AspNetCore.BasicWebApp.Api\src"; 
